...
SQLALCHEMY_DATABASE_URI = "postgresql://${DB_USER}:${DB_PASS}@stardrive_db${DEPLOYMENT_IDENTIFIER}:5432/stardrive"


# Elastic Search
ELASTIC_SEARCH = {
    "index_prefix": "stardrive",
    "hosts": ["stardrive_es${DEPLOYMENT_IDENTIFIER}"],
    "port": 9200,
    "timeout": 20,
    "verify_certs": False,
    "use_ssl": False,
...
API_URL = "http://stardrive_backend${DEPLOYMENT_IDENTIFIER}:5000"
